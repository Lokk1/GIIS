...
public class MainFrame extends JFrame {
	...
	private JComboBox<AlgorithmType> cb;
...
//        scroller.getHorizontalScrollBar().setUnitIncrement(25);
		...
		zoomSlider.addChangeListener(new ChangeListener() {
			public void stateChanged(ChangeEvent e) {
				...
				paintPanel.setPreferredSize( new Dimension((int)screenSize.getWidth() * zoomSlider.getValue(),
						(int)screenSize.getHeight() * zoomSlider.getValue()));
...
//		setResizable(false);
	...
	private JMenuBar createMenu(){
		...
		JMenuItem ellipseBREZ = new JMenuItem("Ållipse");
		...
		menuBar.add(draw);
		menuBar.add(help);
		cb = new JComboBox<AlgorithmType>();
